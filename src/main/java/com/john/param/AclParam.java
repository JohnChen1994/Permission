...
public class AclParam {
    ...
    @Length(min = 2,  max  = 20, message = "权限点名称长度须在2-20之间")
    private String name;

    @NotNull(message = "必须指定权限模块")
    private Integer aclModuleId;

    @Length(min = 6, max = 100 , message = "权限点URL长度需要在6-100")
    private String url;
    ...
    @NotNull(message = "必须指定权限带你的展示顺序")
    private Integer seq;

    @Length(min = 0, max = 200, message = "权限点URL长度须在200字符以内")
